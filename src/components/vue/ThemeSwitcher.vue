  ...
  <TooltipProvider :delay-duration="100">
    <TooltipRoot>
      <TooltipTrigger as-child>
        <button
          class=":uno: theme-toggle text-content m-1 p-2 rounded-md bg-transparent size-[36px] transition-colors focus:bg-surface-2 hover:bg-surface-2"
          aria-live="polite">
          <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" width="1em" height="1em" fill="currentColor"
            class=":uno: theme-toggle__around h-auto w-5" viewBox="0 0 32 32">
