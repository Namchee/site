  ...
  <TooltipProvider :delay-duration="100">
    <TooltipRoot>
      <TooltipTrigger as-child>
        <button
          class=":uno: theme-toggle text-content focus:bg-surface-2 hover:bg-surface-2 m-1 size-[36px] rounded-md bg-transparent p-2 transition-colors"
          aria-live="polite"
        >
          <svg
            ...
            height="1em"
            fill="currentColor"
            class=":uno: theme-toggle__around h-auto w-5"
            viewBox="0 0 32 32"
          >
