...
The primary reason I started this website and write is for learning purposes and recently, I found out that the best ways to do it is by [learning in public](https://www.swyx.io/learn-in-public).
