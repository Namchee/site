...
subtitle: 'You are probably measuring your test quality wrong'
tags:
  - testing
---
...
Fortunately not! Let&apos; revisit the coverage report from [Primers of Code Coverage](#primers-of-code-coverage) section:
