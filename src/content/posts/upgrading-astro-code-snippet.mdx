...
When I first customized this component, I mistakenly believed that there's no way to customize the `<pre>` tag without replacing it.
Therefore, I unnecessarily turned off the syntax highlighting in the Astro config and call the syntax highlighting API manually which can be seen [here](https://github.com/Namchee/site/blob/c2bbc2034972feef20e8b4653dc5965dbe9e18c7/src/components/astro/modules/posts/html/CodeSnippet.astro).

However, as my understanding of MDX and Astro API grows, I realized that those steps are unneccessary and

Lastly, if you like to
