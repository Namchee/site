...
After a short introduction to the API, now you're ready to build your first text fragment. As stated in the previous section, you need to percent-encode the target
text
