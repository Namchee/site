...
There are 2 main advantages of using code coverage as a metric of tests:
...
<dl class=":uno space-y-6">
  ...
  <ListItem>
    Since code coverage is a quantitative metric, code coverage can be easily compared to one another. While this post aims
    to challenge the belief that more coverage means better tests, we can always say that a code with higher coverage
    should generally be more reliable than a code with low coverage.
  </ListItem>
</dl>
