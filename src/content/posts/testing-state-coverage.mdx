...
In modern practice of software development, it's really easy to test our code by simply writing test code that will be executed by an automated test runners.

Test runners instrument your source code, compile them for non-interpreted languages

 and collect various metrics, such as the number of lines, paths, and blocks executed during the test.
