...
## Building The Perfect Freeform Input

To have a better perspective on when should we use which, we are going to do some case study by building a freeform
text input on a chatbot interface.

Assuming that you're familiar with chatbots, the interface always provide the user with a freeform text input
