...
Unlike the traditional text inputs, freeform text inputs are capable of handling reasonably sized
multi-line plain-text inputs which is perfect for comments, feedbacks or in recent cases, inputs
for chatbots.

In a context of a website, freeform text inputs are semantically represented by `<textarea>` element if you're
not doing incredible hacks with `<input>` or building a custom Web Component.

The introduction of HTML5 in [2007](https://www.w3.org/blog/2007/html5-call-to-web-professionals/) brought us a new possibility of defining
freeform text inputs using `contenteditable`, an attribute from the year of [2000](https://blog.whatwg.org/the-road-to-html-5-contenteditable#:~:text=July%202000.%20Microsoft%20releases%20Internet%20Explorer%205.5%2C%20with%20support%20for%20designMode%20and%20contentEditable.%20Other%20than%20some%20sparse%20documentation%20on%20MSDN%2C%20no%20further%20details%20were%20given.)
commonly found in rich-text WYSIWYG editors enumerated within a `<div>`
