...
When writing JavaScript, it's a common occurence to write a non-blocking routine to keep your program
responsive even while doing heavy task on the background.

In the early days of JavaScript, such needs is accomplished through callbacks.
...
Fortunately, `Promise` allows us to
