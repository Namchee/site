...
tags:
  - astro
---
import MarkdownToHTML from '../src/assets/diagrams/posts/upgrading-astro-code-snippets/markdown-to-html.svg';
...
> [!NOTE]
> For the sake of clarity, I'll be changing the default theme of Shiki to `min-light`.
...
or you can go one step further on the features like inline execution, download as file, or even [giving animation of code transformation](https://github.com/shikijs/shiki-magic-move).
